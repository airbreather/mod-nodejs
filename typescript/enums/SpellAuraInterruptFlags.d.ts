declare global {
	const enum SpellAuraInterruptFlags {
		AURA_INTERRUPT_FLAG_HITBYSPELL          = 0x00000001,   // 0    removed when getting hit by a negative spell?
		AURA_INTERRUPT_FLAG_TAKE_DAMAGE         = 0x00000002,   // 1    removed by any damage
		AURA_INTERRUPT_FLAG_CAST                = 0x00000004,   // 2    cast any spells
		AURA_INTERRUPT_FLAG_MOVE                = 0x00000008,   // 3    removed by any movement
		CHANNEL_INTERRUPT_FLAG_INTERRUPT        = 0x00000008,   // 3    mod-nodejs: taken from SpellChannelInterruptFlags
		...
		CHANNEL_FLAG_DELAY                      = 0x00004000,   // 14   mod-nodejs: taken from SpellChannelInterruptFlags
